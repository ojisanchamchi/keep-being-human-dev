...
const config: Config = {
  ...
  tagline: 'A Journey to Human-Centric Development',
  ...
  organizationName: 'ojisanchamchi', // Usually your GitHub org/user name.
  projectName: 'keep-being-human-dev', // Usually your repo name.
